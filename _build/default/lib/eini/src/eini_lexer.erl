...
-file("/Users/arweh002/DevCentre/ErlangDev/dashboard/_build/default/lib/eini/src/eini_lexer.xrl", 60).
...
yystate(9, [C|Ics], Line, Col, Tlen, _, _) when C >= 14, C =< 31 ->
    yystate(9, Ics, Line, Col, Tlen+1, 7, Tlen);
yystate(9, [C|Ics], Line, Col, Tlen, _, _) when C >= 36, C =< 58 ->
    yystate(9, Ics, Line, Col, Tlen+1, 7, Tlen);
yystate(9, [C|Ics], Line, Col, Tlen, _, _) when C >= 62, C =< 90 ->
    yystate(9, Ics, Line, Col, Tlen+1, 7, Tlen);
yystate(9, [C|Ics], Line, Col, Tlen, _, _) when C >= 94 ->
    yystate(9, Ics, Line, Col, Tlen+1, 7, Tlen);
yystate(9, Ics, Line, Col, Tlen, _, _) ->
    {7,Tlen,Ics,Line,Col,9};
yystate(8, [96|Ics], Line, Col, Tlen, _, _) ->
    yystate(9, Ics, Line, Col, Tlen+1, 6, Tlen);
yystate(8, [95|Ics], Line, Col, Tlen, _, _) ->
    yystate(8, Ics, Line, Col, Tlen+1, 6, Tlen);
yystate(8, [94|Ics], Line, Col, Tlen, _, _) ->
    yystate(9, Ics, Line, Col, Tlen+1, 6, Tlen);
yystate(8, [92|Ics], Line, Col, Tlen, _, _) ->
    yystate(9, Ics, Line, Col, Tlen+1, 6, Tlen);
...
yystate(8, [33|Ics], Line, Col, Tlen, _, _) ->
    yystate(9, Ics, Line, Col, Tlen+1, 6, Tlen);
yystate(8, [34|Ics], Line, Col, Tlen, _, _) ->
    yystate(9, Ics, Line, Col, Tlen+1, 6, Tlen);
...
yystate(8, [C|Ics], Line, Col, Tlen, _, _) when C >= 14, C =< 31 ->
    yystate(9, Ics, Line, Col, Tlen+1, 6, Tlen);
yystate(8, [C|Ics], Line, Col, Tlen, _, _) when C >= 36, C =< 44 ->
    yystate(9, Ics, Line, Col, Tlen+1, 6, Tlen);
...
yystate(7, [96|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(9, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, [95|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(8, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, [94|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(9, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, [93|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(3, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, [92|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(9, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, [91|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(7, [60|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(9, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, [59|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(10, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, [58|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(9, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, [47|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(9, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, [45|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(8, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, [46|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(8, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, [35|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(10, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(7, [10|Ics], Line, _, Tlen, Action, Alen) ->
    yystate(6, Ics, Line+1, 1, Tlen+1, Action, Alen);
...
yystate(7, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 14, C =< 31 ->
    yystate(9, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 36, C =< 44 ->
    yystate(9, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(8, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 62, C =< 64 ->
    yystate(9, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(8, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 97, C =< 122 ->
    yystate(8, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 123 ->
    yystate(9, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,Col,7};
yystate(6, [32|Ics], Line, Col, Tlen, _, _) ->
    yystate(1, Ics, Line, Col, Tlen+1, 1, Tlen);
yystate(6, [13|Ics], Line, Col, Tlen, _, _) ->
    yystate(2, Ics, Line, Col, Tlen+1, 1, Tlen);
yystate(6, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(2, Ics, Line+1, 1, Tlen+1, 1, Tlen);
...
yystate(2, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(2, Ics, Line+1, 1, Tlen+1, 0, Tlen);
...
-file("/Users/arweh002/DevCentre/ErlangDev/dashboard/_build/default/lib/eini/src/eini_lexer.xrl", 40).
yyaction_0(TokenLine) ->
     { token, { break, TokenLine } } .

-compile({inline,yyaction_1/1}).
-file("/Users/arweh002/DevCentre/ErlangDev/dashboard/_build/default/lib/eini/src/eini_lexer.xrl", 43).
yyaction_1(TokenLine) ->
     { token, { break, TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("/Users/arweh002/DevCentre/ErlangDev/dashboard/_build/default/lib/eini/src/eini_lexer.xrl", 46).
yyaction_2(TokenLine) ->
     { token, { '=', TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("/Users/arweh002/DevCentre/ErlangDev/dashboard/_build/default/lib/eini/src/eini_lexer.xrl", 47).
yyaction_3(TokenLine) ->
     { token, { '[', TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("/Users/arweh002/DevCentre/ErlangDev/dashboard/_build/default/lib/eini/src/eini_lexer.xrl", 48).
yyaction_4(TokenLine) ->
     { token, { ']', TokenLine } } .

-compile({inline,yyaction_5/2}).
-file("/Users/arweh002/DevCentre/ErlangDev/dashboard/_build/default/lib/eini/src/eini_lexer.xrl", 51).
yyaction_5(TokenChars, TokenLine) ->
     { token, { blank, TokenLine, TokenChars } } .

-compile({inline,yyaction_6/2}).
-file("/Users/arweh002/DevCentre/ErlangDev/dashboard/_build/default/lib/eini/src/eini_lexer.xrl", 52).
yyaction_6(TokenChars, TokenLine) ->
     { token, { word, TokenLine, TokenChars } } .

-compile({inline,yyaction_7/2}).
-file("/Users/arweh002/DevCentre/ErlangDev/dashboard/_build/default/lib/eini/src/eini_lexer.xrl", 53).
yyaction_7(TokenChars, TokenLine) ->
     { token, { value, TokenLine, TokenChars } } .

-compile({inline,yyaction_8/2}).
-file("/Users/arweh002/DevCentre/ErlangDev/dashboard/_build/default/lib/eini/src/eini_lexer.xrl", 56).
yyaction_8(TokenChars, TokenLine) ->
